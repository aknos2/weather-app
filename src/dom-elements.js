...
export const todayDayOfTheWeek = document.querySelector(
  "#today-day-of-the-week",
);
export const cityName = document.querySelector("#city-name");
export const upperContainer = document.querySelector(
  "#weather-forecast-upper-container",
);
export const bottomContainer = document.querySelector(
...
export const alertMessageContainer = document.querySelector(
