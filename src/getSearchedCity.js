import { getCurrentTime, getCurrentLocationDate, getWeekDay, formatDate } from "./getLivingCityTime";
import { todayDate, todayTime, todayDayOfTheWeek, cityName, searchInput } from "./dom-elements";
